...
% - Easily supported by remote.
% - Services offered to install the system professionaly, but the option
%   available to self install.
% - Should support most sensors available on the market.
