...
of what order things need to be handled in. Therefore, the intended audience is 
the project managers and developers of the system, particularly on the software side. 
This document is not intended for the low-level hardware designers of the system. The 
non-functional requirements of the document are to help guide the project managers in 
order to keep focus on things that are required but not within the scope of software design. 
The last section of the document is meant to help the UI designers understand the 
requirements of the UI by providing them with wireframe diagrams and use-case scenarios.
...
% Problem: Security, energy management, family safety
% Objectives: Develop a system that responds to security events quickly and
% appropriately with adequate coverage. 
