...
% - should be usuable by school-aged children --
% - unique user ids should be assigned to all users of the system (parents,
%   children, caretakers/babysitters, cleaners, etc) -- 
% - Only the parents should be fully trained in maintaining and understanding
%   the system -- 
% - System should be seemless in terms of usability 
% - Simple user centeric I/O devices

\section{Reliability}
% - Handles power outages
% - Any sensor placed outside need to be rugged and durable
% - 

\section{Performance}
% - Controller needs to be able to handle all of the sensor requests
...
\section{Packaging}
% - Each wireless sensor should be individually packaged
% - The whole system should be packaged as one unit with additional sensors
%   available
% - Outdoor sensors needs to be ruggedized for weather and animals

\section{Legal Issues}
% - Residents need to be informed of the legality of video and audio recording
%   in their area and where these devices can be implemented.
% - User should agree to an End User License Agreement to ensure that they
%   understand the liabilities and coverage of the system.
