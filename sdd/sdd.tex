...
The Communications Protocol component handles serializing Event
objects into a form that can be sent across the Hardware
Interface. This component also handles protocol level flow
control. Large Event objects will need to be split up into multiple
...
required for the Event object and its descendants. These classes form
the highest layer of the communications stack and are used by the
other GARTH systems to communicate Events at a high level. This layer
forms the highest level of the communications stack.
